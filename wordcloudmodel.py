...
depressive_words = ' '.join(list(tweets[tweets['target'] == 0]['text']))
...
positive_words = ' '.join(list(tweets[tweets['target'] == 4]['text']))
...
class TweetClassifier(object):
    def __init__(self, trainData, method='tf-idf'):
        self.tweets, self.labels = trainData['text'], trainData['target']
        self.method = method
...
while (True):
    msg = input("Enter tweet : ")
    pm = process_message(msg)
    print("{BOW method} Depression = ", sc_bow.classify(pm))

    pm = process_message(msg)
    print("{tf-idf method} Depression = ", sc_tf_idf.classify(pm))